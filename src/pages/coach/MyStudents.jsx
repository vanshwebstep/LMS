  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        if (alive) setError(err?.message || "Students load nahi ho paaye");
      } finally {
